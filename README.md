...
1. **Deep Research** — Takes a founder's LinkedIn URL and autonomously researches their background, company, industry, and public content
...
- **Skill: `mindmap`** — Main orchestrator that runs the full workflow
